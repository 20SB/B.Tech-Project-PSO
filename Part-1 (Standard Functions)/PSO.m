...
for t = 1:T
    ...
    disp(['Iteration' num2str(t) ': Best Fitness = ' num2str(BestFitIter(t+1))]); 
                                                         % Displaying the the best fitness value with iteration no.
end
BestFitness = f_gbest
BestSol = gbest
...
% subplot(1,2,1) 
% plot(0:T,BestFitIter);                               % Plotting the best fitness value vs iteration no. curve
% xlabel('Iteration');                                 % Naming the X-axis
% ylabel('Best Fitness Value');                        % Naming the Y-axis
% 
% subplot(1,2,2)
% semilogy(0:T,BestFitIter);                           % Plotting the best fitness value vs iteration no. curve in semilog plot
% xlabel('Iteration');                                 % Naming the X-axis
% ylabel('Best Fitness Value');                        % Naming the Y-axis